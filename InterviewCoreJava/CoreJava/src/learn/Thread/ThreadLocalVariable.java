...
//Concept of Thread Local class (Thread Local Variable)
...
class Task implements Runnable{
    ...
    public void run() {
        for(int i=0; i<2; i++){
            ...
            System.out.println("Thread: " + Thread.currentThread().getName() + " Formatted Date: " + ThreadLocalVariable.threadSafeFormat(new Date()) );
        }       
    }
}
