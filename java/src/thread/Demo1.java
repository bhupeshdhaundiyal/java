...
public static void main(String[] args) throws InterruptedException {
	Job job = new Job("E:\\4to6batch\\ThreadFiles\\test.txt","D:\\4to6batch\\ThreadFiles\\testWrite.txt");  
	// Create Object of the Job
	// Create Worker and Assign the Job to the Worker
	Thread worker1 = new Thread(job,"Worker1");
	
	Job job2 = new Job("E:\\4to6batch\\ThreadFiles\\test2.txt","D:\\4to6batch\\ThreadFiles\\testWrite2.txt");
